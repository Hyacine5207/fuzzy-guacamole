import matplotlib
matplotlib.use('Agg')  # 强制使用无界面后端，完全绕开Tcl/Tk依赖
import matplotlib.pyplot as plt  # 后续正常导入plt
...
plt.savefig("iris_classifier_result.png", dpi=300, bbox_inches='tight')  # 保存图片到当前目录
#plt.show()
